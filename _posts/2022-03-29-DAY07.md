...
<p class='notice--success'>
	...
	진짜 가장 큰 수 문제 풀다가 찔끔 울 뻔 했습니다.<br>
...
디버깅만 한시간 한 것 같은데 i를 1로 잘못 썼었네요 하하<br>
<br>
풀이 방법은 체스판 전체를 탐색하는 것이 아니라, row로만 탐색합니다.<br>
<span style="background-color:#fff5b1;">row의 인덱스는 행,  row의 값은 열로 두고</span> 풀이를 진행합니다.<br>
<br>
...
타뷸레이션은 **미리 계산**해둡니다. (Eager evaluation)<br>
<br>
...
> 😥 풀다가 울뻔했습니다.<br>
<br>
모든 알고리즘 문제 유형 중 그리디와 dp를 제일 어려워하는 저에게 가장 큰 수 문제는 정말 힘들었습니다.<br>
<br>
<span style="background-color:#fff5b1;">**원리)**</span><br>
1. 단어를 문자열에서 잘라서 단어 조각에 있는지 비교한다.
2. 있으면 해당 단어의 개수로 dp[단어 끝자리 idx + 1]를 갱신한다. 
...
→ an과 ban은 없음<br>
<br>
**4. a로 끝나는 단어인 a, na, ana, bana를 단어 조각에 있는지 검사한다.**<br>
...
... <br>
<br>
해당 과정을 반복하다보면 <span style="background-color:#fff5b1;">dp의 맨 마지막 부분에 최소 단어의 개수가 저장</span>된다. 😊
> 
